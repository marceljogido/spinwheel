	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'spin-wheel': 'spin-wheel var(--spin-duration) cubic-bezier(0.23, 1, 0.32, 1) forwards',
				'bounce-in': 'bounce-in var(--bounce-duration) ease-out',
